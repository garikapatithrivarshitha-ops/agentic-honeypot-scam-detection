...
Scam Analyzer evaluates the message
A scam score is generated
If score ≥ threshold → Honeypot is activated
Honeypot interacts autonomously with the scammer
Intelligence is extracted and stored
Results are shown in the dashboard
✨ Key Features
🔍 Scam Analyzer
...
Your reward points are expiring today. Pay ₹99 now to activate redemption. Send payment to rewardsverify@upi.

Your courier is on hold due to address issue. Pay ₹25 via UPI to reschedule delivery.
